...
<!DOCTYPE html>
    <html lang=pt-br>
       ...
       <section class="form">
       <div class="solicitar">
            <a class="orc" id="inicio"> Cadastro para solicitação de orçamento </a>
        </div>
        ...
        <h2> Informações Pessoais: </h2>
            ...
            <textarea id="caracteristicas" value="<?=$caracteristicas?>" name="caracteristicas"> Por exemplo, número de quartos, espaços abertos, requisitos de iluminação, acessibilidade, sustentabilidade, etc.</textarea>
            </div>
            ...
            <a href="cliente/login.php" id="login"> Já solicitei o meu orçamento! </a>
        </form>
        </section>
        <!-- rodapé -->
        <footer id="info">
