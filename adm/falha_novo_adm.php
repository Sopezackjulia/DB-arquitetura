<!DOCTYPE html>
    <html lang=pt-br>
        ...
        <div id="envio">
        <h1> FALHA EM ADICIONAR ADMINISTRADOR! </h1> <br>
        <h5> Você deverá tentar novamente <br> no link abaixo! </h5>
        <a href="novo_adm.php" id="form"> Adicionar novo administrador </a>
        </div>
        <!-- rodapé -->
        <footer id="info">
