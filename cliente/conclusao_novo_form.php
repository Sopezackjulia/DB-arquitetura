...
<!DOCTYPE html>
    <html lang=pt-br>
        ...
        <div id="envio">
        <h1> PEDIDO DE ORÇAMENTO ENVIADO COM SUCESSO! </h1> <br>
        <h5> Você poderá verificar o andamento do seu pedido na página inicial! </h5>
        <a href="inicio_login.php" id="login"> Página inicial </a>
        </div>
        <!-- rodapé -->
        <footer id="info">
